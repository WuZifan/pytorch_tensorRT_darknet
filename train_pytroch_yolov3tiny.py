...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_config", type=str, default="config/warehouse.data", help="path to data config file")
    ...
    # Initiate model
    model = MyTinyYolov3(num_class=2,img_size=416,is_trained=True).to(device)
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(model.state_dict(), "checkpoints/yolov3-mytiny_{}_{}_warehouse.pth".format(epoch,AP.mean()))
